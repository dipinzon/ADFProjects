...
@Stateless(name="oracle.summit.model.amservice.common.ServiceAppModuleServiceBean", mappedName="ServiceAppModuleServiceBean")
...
@PortableWebService(targetNamespace="/oracle/summit/model/amservice/common/", serviceName="ServiceAppModuleService",
    portName="ServiceAppModuleServiceSoapHttpPort", endpointInterface="oracle.summit.model.amservice.common.serviceinterface.ServiceAppModuleService")
public class ServiceAppModuleServiceImpl extends ServiceImpl implements ServiceAppModuleService {
    ...
    protected void init() {
        ...
        synchronized (ServiceAppModuleServiceImpl.class) {
            ...
            try {
                SDOHelper.INSTANCE.defineSchema("oracle/summit/model/amservice/common/serviceinterface/", "ServiceAppModuleService.xsd");
                _isInited = true;
            } catch (Exception ex) {
