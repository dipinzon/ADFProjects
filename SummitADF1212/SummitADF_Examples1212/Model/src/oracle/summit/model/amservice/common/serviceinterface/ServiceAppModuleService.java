...
public interface ServiceAppModuleService {
    ...
    @WebMethod(action="/oracle/summit/model/amservice/common/createCustomersView", operationName="createCustomersView")
    @RequestWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="createCustomersView")
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="createCustomersViewResponse")
    ...
    @WebMethod(action="/oracle/summit/model/amservice/common/updateCustomersView", operationName="updateCustomersView")
    @RequestWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="updateCustomersView")
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="updateCustomersViewResponse")
    @WebResult(name="result")
    CustomersViewSDO updateCustomersView(@WebParam(mode = WebParam.Mode.IN, name="customersView")
        CustomersViewSDO customersView) throws ServiceException;

    @WebMethod(action="/oracle/summit/model/amservice/common/deleteCustomersView", operationName="deleteCustomersView")
    @RequestWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="deleteCustomersView")
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="deleteCustomersViewResponse")
    void deleteCustomersView(@WebParam(mode = WebParam.Mode.IN, name="customersView")
        CustomersViewSDO customersView) throws ServiceException;

    @WebMethod(action="/oracle/summit/model/amservice/common/mergeCustomersView", operationName="mergeCustomersView")
    @RequestWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="mergeCustomersView")
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="mergeCustomersViewResponse")
    @WebResult(name="result")
    ...
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="createOrdersViewResponse")
    @WebResult(name="result")
    ...
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="updateOrdersViewResponse")
    @WebResult(name="result")
    ...
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="deleteOrdersViewResponse")
    ...
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="mergeOrdersViewResponse")
    @WebResult(name="result")
    ...
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="getDfltCtrlHintsResponse")
    @WebResult(name="result")
    ...
    @WebMethod(action="/oracle/summit/model/amservice/common/findOrdersViewOrdersViewCriteria", operationName="findOrdersViewOrdersViewCriteria")
    @RequestWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="findOrdersViewOrdersViewCriteria")
    @ResponseWrapper(targetNamespace="/oracle/summit/model/amservice/common/types/", localName="findOrdersViewOrdersViewCriteriaResponse")
    @WebResult(name="result")
    List<OrdersViewSDO> findOrdersViewOrdersViewCriteria(@WebParam(mode = WebParam.Mode.IN, name="findCriteria")
        FindCriteria findCriteria, @WebParam(mode = WebParam.Mode.IN, name="OrdId")
        String OrdId, @WebParam(mode = WebParam.Mode.IN, name="findControl")
